...
enum parameters {CONSTT, KAP, CONSTD, CONSTL, CONSTN,F_X,F_Y};
...
class mesh{
    ...
    public:
        void setParameters(float constT,float kap, float constD,float constL,float constN, float f_x, float f_y){
            parameters[CONSTT] = constT;
            parameters[KAP] = kap;
            parameters[CONSTD] = constD;
            parameters[CONSTL] = constL;
            parameters[CONSTN] = constN;
